...
export function buildSupportInstructions({
  ...
  if (locale === "ar") {
    return [
      ...
      "عند ذكر أكثر من منتج أو خيار أو خطوة، نسّق الرد على شكل فقرات قصيرة أو نقاط منفصلة. لا تجمع كل التوصيات في فقرة كثيفة واحدة.",
  ...
  return [
    ...
    "When you mention multiple products, options, or steps, format the reply as short paragraphs or bullets with one item per line instead of one dense paragraph.",
